package com.pluralsight.jsr310.m3;
...
public class Event implements Comparable<Event> {
	...
	public String toString(ZoneId zone) {
		return("\n\t" + description + ": " + startTime.withZoneSameInstant(zone) + ", duration = " + Duration.between(startTime, endTime));
	}

	@Override
	public String toString() {
		return("\n\t" + description + ": " + startTime + ", duration = " + Duration.between(startTime, endTime));
	}
